...
<arca-preference>
Sustituir `model="gpt-4.1"` por `model="anthropic:claude-sonnet-4-6"` al usar Deep Agents en ARCA. La convención `gpt-4.1` proviene de la doc oficial de Deep Agents (LangChain) para coherencia con sus ejemplos canónicos.
</arca-preference>
