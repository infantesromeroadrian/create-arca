...
<arca-preference>
Sustituir `"gpt-4.1-mini"` por `"anthropic:claude-sonnet-4-6"` en código ARCA. El nombre `gpt-4.1-mini` aquí refleja la convención de la doc oficial de LangGraph para sub-agent demos.
</arca-preference>
