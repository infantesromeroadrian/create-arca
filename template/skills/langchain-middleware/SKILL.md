...
<arca-preference>
Sustituir `model="gpt-4.1"` por `"anthropic:claude-sonnet-4-6"` al adaptar a código ARCA. Los ejemplos siguen la convención oficial de la doc LangChain v1 para que sean comparables con otras skills del cluster (langchain-fundamentals, langgraph).
</arca-preference>
