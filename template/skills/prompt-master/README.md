...
| **your-mobile-stack** | Computer-use agent | Conversational precision, persistent memory, security constraints |
...
- **1.6.0** — Opus 4.8 update. Added Template M (Opus 4.8 Task Brief). Updated Claude and Claude Code routing for literalism, adaptive thinking, xhigh effort, and session hygiene. Added patterns 36–37.
