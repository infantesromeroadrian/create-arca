...
| [M — Opus 4.8 Task Brief](#template-m--opus-48-task-brief) | Complex, multi-step, or agentic task on Claude Opus 4.8 |
...
## Template M — Opus 4.8 Task Brief

*Use for any complex, multi-step, or agentic task on Claude Opus 4.8 — claude.ai, API, or Claude Code. Opus 4.8 reads prompts literally. Missing context produces narrow output. This template front-loads everything so the first turn is the only turn.*
...
**When to use:** Opus 4.8 on any surface — claude.ai, API, Claude Code — when the task is complex, multi-file, ambiguous, or agentic. Not needed for simple one-shot tasks.
